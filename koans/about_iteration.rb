...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # the inject method would accumulate the given number to the set of current numbers, and 
    # then pass these new numbers to the next process. For the first inject, it adds 0 to every
    # element of result and then do the sum. For the second inject, it times 1 to every element
    # of result and do the production.
  end
